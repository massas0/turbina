...
CCSWeaponInfo* C_BaseWeapon::GetCSWeaponData()
{
	...
	return VT::VFunc<OriginalFn>(this, 446)(this);
}
...
HANDLE CCSBomb::GetOwnerHandle()
{
	return *(HANDLE*)((uintptr_t)this + NetVars.m_hOwner);
}

float CCSBomb::GetC4BlowTime()
{
	return *(float*)((uintptr_t)this + NetVars.m_flC4Blow);
}

float CCSBomb::GetC4DefuseCountDown()
{
	return *(float*)((uintptr_t)this + NetVars.m_flDefuseCountDown);
}

int CCSBomb::GetBombDefuser()
{
	return *(int*)((uintptr_t)this + NetVars.m_hBombDefuser);
}

bool CCSBomb::IsBombDefused()
{
	return *(bool*)((uintptr_t)this + NetVars.m_bBombDefused);
}
